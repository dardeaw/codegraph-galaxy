...
def main():
    ...
    parser.add_argument("-p", "--port", type=int, default=5001, help="Port to run the server on (default: 5001)")
    parser.add_argument("-H", "--host", default="127.0.0.1", help="Host address (default: 127.0.0.1)")
